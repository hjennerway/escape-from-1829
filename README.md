...
The two-storey range beside the square projection includes an open ground-floor passage beneath its upper floor. It connects the front lawn to the eastern courtyard and can be walked through in either direction in Explore mode.

The right-hand frontage retains the original curved bay. The added pavilion beside the square projection is two storeys, with two rows of windows and a lowered roof. The added round bay has been removed; a three-storey square section projects outward from the blue-marked window section to its left, with matching sash windows, stone bands and a slate roof. The extension and adjoining parking/road remain shifted outward by one pavilion width. The rear-left courtyard entrance remains open. Open `escape-preview.html?view=right` for a stationary front-facing view.
