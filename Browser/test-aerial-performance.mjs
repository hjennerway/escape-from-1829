...
const trees=exterior.trees.children.filter(o=>o.userData.adminPineTree||o.userData.frontLawnTree);
assert.equal(trees.length,13);
for(const key of ['adminPineTree','frontLawnTree']){
...
assert(treeTriangles<180000,'Distant trees should submit substantially less geometry');
