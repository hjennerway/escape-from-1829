...
const trees=exterior.trees.children.filter(o=>o.userData.adminPineTree||o.userData.beechTree||o.userData.oakTree);
assert.equal(trees.length,41);
for(const key of ['adminPineTree','beechTree','oakTree']){
...
assert(treeTriangles<180000+22*11000+2*10000,'Distant trees should submit substantially less geometry');
