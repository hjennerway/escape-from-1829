// The red/yellow guide supersedes the initial 15% depth increase.
// Rear wall: map z=-54.35, 6.75 map units farther back than z=-47.6.
// The rear court grows away from its fixed join to the spine.
// Coordinates are in the existing map frame; width and height stay unchanged.
export const ANNEXE_REAR_STRETCH=Object.freeze({factor:1.43125,anchor:-20,back:-44});
