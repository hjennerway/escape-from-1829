...
export const BUILDING_CATALOG=Object.freeze([
 ...
 {id:'hale-daresbury',name:'Hale / Daresbury Ward',photos:[]},
 {id:'huxley-dunham',name:'Huxley / Dunham Ward',photos:[]},
 ...
 {id:'irby-ashley',name:'Irby / Ashley Ward',photos:[photo('irby-1','Irby / Ashley · garden view'),photo('irby-3','Irby / Ashley · side view'),photo('irby-4','View from Main/Admin'),photo('irby-ashley-mural','Irby / Ashley Ward · stairwell mural')]},
 ...
 {id:'church',name:'Church',photos:[photo('church','Church and grounds · aerial photograph')]},
 ...
 {id:'main-admin',name:'Main / Admin Building',photos:[photo('admin-1','Main/Admin · side elevation'),photo('admin-2','Main/Admin · rear court')]},
