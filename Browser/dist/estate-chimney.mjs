...
// Latest tower-buildings red X: beside the extended central hall's west wall.
...
export function createEstateChimney(THREE,{brick,material}){
  ...
  chimney.userData.height=height;chimney.userData.reference='Research/tower-buildings/central-hall-footprint-correction.png red X (15 September 2026); chimney/img1.jpg; 1.3 times the water-tower height';
  return chimney;
}
