...
assert(Math.abs(frontCorners[0].distanceTo(frontCorners[1])-64.82363778290825*.648*.85)<1e-6,'The complete annexe plan is reduced by a further 15% for the new loop');
assert.deepEqual(annexe.scale.toArray(),[.5508,.9,.5508],'The complete plan shrinks uniformly while heights stay fixed');
