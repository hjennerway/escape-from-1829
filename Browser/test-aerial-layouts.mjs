...
for(const historic of [true,false])for(const modern of [true,false]){
 ...
 for(const o of [exterior.towerBuildings,exterior.annexe,exterior.mainAdmin,exterior.adminCorridor,exterior.estateChimney])assert.equal(visible(o),historic);
