...
let toggle;
bindPlanterToggle(exterior,{addEventListener(type,listener){toggle=listener;}});
sun.shadow.needsUpdate=false;
toggle({code:'KeyH',preventDefault(){}});
assert(exterior.planters.visible);assert(sun.shadow.needsUpdate,'Planter visibility must refresh shadows');
