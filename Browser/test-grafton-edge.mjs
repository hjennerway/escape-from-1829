...
import {graftonEdgePoint as sourcePoint,GRAFTON_EDGE_VIEWS} from './dist/grafton-edge.mjs';
...
const offset=ward.userData.placement.offset;
const graftonEdgePoint=p=>{const [x,z]=sourcePoint(p);return [x+offset.x,z+offset.z];};
...
assert.deepEqual(original.position.toArray(),[234,0,-93.4]);
