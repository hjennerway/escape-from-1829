...
for(const name of ['Oakmere cross-gable slate roof','Oakmere raised spine slate roof','Oakmere low rear end room slate roof','Oakmere low hall link slate roof']){
...
console.log('PASS: all new Oakmere glazing is exposed, roof slopes face upward, walking approach and facade collisions work, and details follow Historic visibility.');
