...
for(const p of [[263.25,-108],[260.65,-90],[267,-108],[267,-94],[267,-80],[265,-72],[246,-72],[229,-80],[245,-80]])assert(roadsAt(...p).some(h=>h.object.userData.surface==='black road'),'Flush side/front connection: '+p);
for(let x=205;x<263;x+=.8)for(let z=-113;z<-74;z+=.8){
