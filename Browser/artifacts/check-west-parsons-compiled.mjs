...
await page.goto(base+'/aerial.html?models=compiled',{timeout:120000});
...
await page.waitForTimeout(1000);await page.screenshot({path:'Browser/artifacts/west-parsons-joins-compiled.png'});
