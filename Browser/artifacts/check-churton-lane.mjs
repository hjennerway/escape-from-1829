...
e.camera.position.set(-38,42,-132);e.camera.lookAt(-38,0,-91);controls.sync([-38,0,-91]);e.camera.updateMatrixWorld();
});
...
await page.waitForTimeout(1000);await page.screenshot({path:'Browser/artifacts/churton-lawn-edge-after.png'});
