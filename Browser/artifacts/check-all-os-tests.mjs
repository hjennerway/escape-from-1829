...
const previous=process.argv.length>2?JSON.parse(readFileSync(new URL('../../Research/annexe-os-refinement/test-results.json',import.meta.url))):[];
...
writeFileSync(new URL('../../Research/annexe-os-refinement/test-results.json',import.meta.url),JSON.stringify(results,null,2)+'\n');
