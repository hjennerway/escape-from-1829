...
try{
 const page=await browser.newPage({viewport:{width:1390,height:846}});page.setDefaultNavigationTimeout(120000);
 ...
 for(const [name,pos,target] of [['reference',[228,150,-140],[333,0,-23]],['plan',[365,220,-9.01],[365,0,-9]]]){
  ...
  await page.screenshot({path:new URL(`annexe-inward-${phase}-${mode}-${name}.png`,import.meta.url).pathname.slice(1)});
