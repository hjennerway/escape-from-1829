...
import {createEscapeExterior} from './escape-exterior-baseline.mjs';
...
const rearPad=annexeGroundPoint(12,0,-88);assert.equal(surface(rearPad[0],rearPad[2]),'black road','The unmarked rear hardstanding remains');
...
console.log('PASS: red-line avenue, clear central sweep, yellow gravel link, removed side approaches, preserved rear access, joined roads, translated teardrop and Historic visibility.');
