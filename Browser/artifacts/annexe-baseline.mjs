import {addOakmereElevation} from './annexe-oakmere-baseline.mjs';
import {addOuterFronts} from './annexe-outer-baseline.mjs';
import {ANNEXE_PLACEMENT_REFERENCE,annexePlacementMapPoint,placeAnnexeFront} from '../dist/annexe-placement.mjs';
import {ANNEXE_GROUNDS,annexeGroundPoint} from '../dist/annexe-ground-placement.mjs';
...
export const ANNEXE_VIEWS=Object.freeze({
 ...
 'annexe-outer-west':shot([-137,2,41],[-99,5.5,19],58),
 'annexe-outer-east':shot([137,2,41],[99,5.5,19],58),
