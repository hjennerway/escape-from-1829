...
const pixels=[[555,91],[648,95],[726,206],[618,201],[619,219],[716,223]];
...
const marks=Object.fromEntries(Object.entries({circle:[565,410],currentCentre:[476,420],junction:[605,319]}).map(([k,p])=>[k,ground(p)]));
...
writeFileSync(new URL('../../Research/outhouse/junction-fit.json',import.meta.url),JSON.stringify(result,null,2));console.log(result);
