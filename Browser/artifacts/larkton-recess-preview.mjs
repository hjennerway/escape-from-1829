...
try{
 ...
 for(const [name,p,t,fov] of [
  ['oblique',[-100,112,58],[-100,0,-25],48],
  ['close',[-60,24,18],[-70,4,-2],44],
  ['lawn',[-76,2.2,22],[-77,4.5,-1],48]
 ]){
  ...
  await page.screenshot({path:fileURLToPath(new URL('larkton-recess-'+phase+'-'+mode+'-'+name+'.png',import.meta.url))});
 }
