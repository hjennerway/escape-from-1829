...
try{
 ...
 for(const [name,pos,target] of [['oblique',[190,310,-270],[407,0,-31]],['plan',[407,410,-31.01],[407,0,-31]],['marked',[130,235,-31],[405,0,-31]],['entrance',[102,190,-82],[322,0,-42]],['frontage',[458,250,115],[312,0,-30]]]){
  ...
  await page.screenshot({path:new URL(`annexe-loop-${phase}-${mode}-${name}.png`,import.meta.url).pathname.slice(1)});
